...
- **Tarjetas del dashboard:** Registros de Vinculación (pasante, Cintya, superadmin; con "Registrar Evento o Podcast" para todos, "Registrar Actividades de Investigación" solo pasante con `investigacion` y "Registrar Horas / Actividades Autónomas" para todo pasante), Supervisión de Vinculación (supervisores y líder), Gestión de Vinculación (líder), Gestionar Investigación (`investigacion`), Roles y usuarios (`admin`), Administrador de sitio, Superadmin. El aviso "sin módulos" ya no sale a docentes.
