...
- **Beneficiarios normalizados** a "Nombre Apellido" (respaldo en la tabla `respaldo_beneficiarios_nombres_20260925`, borrable). Hay 5 pares candidatos a duplicado pendientes de decisión del usuario; **no se eliminó nada**.
