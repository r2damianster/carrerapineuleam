...
const translations = {
  es: {
    ...
    attendanceForm: {
      ...
      connectionErrorMessage: 'No se pudo conectar al servidor local. Verifica que PocketBase esté corriendo.',
    },
  },
  en: {
    nav: {
    ...
    attendanceForm: {
      ...
      connectionErrorMessage: 'Could not connect to the local server. Make sure PocketBase is running.',
    },
  },
};
