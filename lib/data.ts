...
// autorización (siteSettings sigue sin migrar). Las fotos del Club de Inglés
// se migraron al Banco de Fotos (tabla `fotos`, ubicacion='club-ingles',
// Sesión 36) — ver `components/EnglishClubSection.tsx`.
// ============================================================================
